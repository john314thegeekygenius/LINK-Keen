...
#include "CK_Data/keen_sheet4b.h"
#else
...
#ifdef LK_MULTIBOOT_ROM
#include "CK_Data/ck5_sprites4b.h"
#else
...
const unsigned short ck_tile_palette[] = {
	0x67f9, 0x0, 0x5400, 0x2a0, 0x56a0, 0x15, 0x5415, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	0x67f9, 0x0, 0x5400, 0x2a0, 0x56a0, 0x15, 0x5415, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	0x67f9, 0x0, 0x5400, 0x2a0, 0x56a0, 0x15, 0x5415, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	0x67f9, 0x0, 0x5400, 0x2a0, 0x56a0, 0x15, 0x5415, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	0x67f9, 0x0, 0x5400, 0x2a0, 0x56a0, 0x15, 0x5415, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
...
const unsigned short ck_sprites_palette [] = {
	0x67f9, 0x0, 0x5400, 0x2a0, 0x15, 0x5415, 0x155, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	0x67f9, 0x0, 0x0, 0x15, 0x15, 0x15, 0x294a, 0x56b5, 0x294a, 0x294a, 0x56b5, 0x56b5, 0x295f, 0x295f, 0x294a, 0x7fff, 
	0x67f9, 0x0, 0x56a0, 0x0, 0x2bff, 0x56a0, 0x155, 0x294a, 0x294a, 0x7fea, 0x0, 0x7fea, 0x2bff, 0x7fea, 0x0, 0x155, 
	0x67f9, 0x0, 0x56a0, 0x2a0, 0x5415, 0x56a0, 0x155, 0x56b5, 0x294a, 0x7fea, 0x2bea, 0x7fea, 0x7d5f, 0x7fea, 0x2bff, 0x7fff, 
	0x67f9, 0x0, 0x2a0, 0x294a, 0x56a0, 0x2a0, 0x294a, 0x7d4a, 0x294a, 0x2bea, 0x7fea, 0x7fea, 0x7fea, 0x2bea, 0x56a0, 0x56a0, 
	0x67f9, 0x0, 0x15, 0x7fff, 0x15, 0x15, 0x294a, 0x56b5, 0x294a, 0x295f, 0x7fff, 0x295f, 0x295f, 0x295f, 0x7fff, 0x7fff, 
	0x67f9, 0x0, 0x155, 0x294a, 0x155, 0x155, 0x155, 0x56b5, 0x294a, 0x2bff, 0x56b5, 0x2bff, 0x2bff, 0x2bff, 0x0, 0x7fff, 
	0x67f9, 0x0, 0x5400, 0x2a0, 0x15, 0x5415, 0x155, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	0x67f9, 0x0, 0x5400, 0x2a0, 0x15, 0x5415, 0x155, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	0x67f9, 0x0, 0x5400, 0x2a0, 0x15, 0x5415, 0x155, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	0x67f9, 0x0, 0x5400, 0x2a0, 0x15, 0x5415, 0x155, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	...
	0x67f9, 0x0, 0x5400, 0x2a0, 0x15, 0x5415, 0x155, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	0x67f9, 0x0, 0x5400, 0x2a0, 0x15, 0x5415, 0x155, 0x56b5, 0x294a, 0x7d4a, 0x2bea, 0x7fea, 0x295f, 0x7d5f, 0x2bff, 0x7fff, 
	0x67f9, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 0x7fff, 
};
...
#ifdef LK_MULTIBOOT_ROM
	GBA_DMA_Copy16((uint16_t*)GBA_PAL_SPR_START,(uint16_t*)ck_sprites_palette,GBA_PAL_SIZE);
#else
...
#ifdef LK_MULTIBOOT_ROM
	int i;
	for(i = 0; i < ck5_sprites_height>>2;i++)
		GBA_DMA_Copy16((uint16_t*)GBA_SPRGFX_START+cki_itemsSheet+(i<<9),(uint16_t*)ck5_sprites_data+(i<<8),(ck5_sprites_width)<<2);
#else
	// Data
...
void LK_CA_HackPlayerSprite(int sprId1, int sprId2, int sprId3, int sheetId,int sheetrotation, int pid, int white){
	...
	if(sprId2 != lastSprID[sheetId]){
		...
		GBA_DMA_MemSet32((uint16_t*)GBA_SPRGFX_START+sprOff+(32*16),0,16*3);
		GBA_DMA_MemSet32((uint16_t*)GBA_SPRGFX_START+sprOff+(64),0,16*3);
	}

	GBA_DMA_Copy32((uint16_t*)GBA_SPRGFX_START+sprOff,data+(sprId1*16),16); // Top
	GBA_DMA_Copy32((uint16_t*)GBA_SPRGFX_START+sprOff+(32*16),data+(sprId1*16)+(cki_playerSheetWidth<<1),16); // Middle
	GBA_DMA_Copy32((uint16_t*)GBA_SPRGFX_START+sprOff+(32),data+(sprId2*16)+(cki_playerSheetWidth<<1),16); // Bottom

	if(sheetrotation==1){
		GBA_DMA_Copy32((uint16_t*)GBA_SPRGFX_START+sprOff+(64),data+(sprId3*16),16); // Extra (Horizontal)
	}else{
		GBA_DMA_Copy32((uint16_t*)GBA_SPRGFX_START+sprOff+(64),data+(sprId3*16),8); // Extra (Virtical)
		GBA_DMA_Copy32((uint16_t*)GBA_SPRGFX_START+sprOff+(64)+(32*16),data+(sprId3*16)+16,8); // Extra (Virtical)
	}
